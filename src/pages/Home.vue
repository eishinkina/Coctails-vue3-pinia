...
<template>
  <div>
    <!-- <AppLayout imgUrl="/src/assets/img/bg1.jpeg" :backFunc="removeIngredient"> -->
    <AppLayout imgUrl="/src/assets/img/bg1.jpeg" :backFunc="removeIngredient" :isBackButtonVisible="rootStore.ingredient !== null">
      <div class="wrapper">
